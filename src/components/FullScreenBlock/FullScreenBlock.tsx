    ...
    <div className="full-screen-block">
      <div className="full-screen-block__container">
        ...
        <ul className="full-screen-block__list">
          <li className="full-screen-block__list-item">TypeScript tasks</li>
          <li className="full-screen-block__list-item">Online learning</li>
          <li className="full-screen-block__list-item">Theory and practice</li>
        </ul>
        <button className="full-screen-block__button">Start</button>
      </div>
    </div>
  );
}
